...
void writeArduinoOn7Segment() {
    ...
    delay(delaytime);
    Serial.println("setChar a");
    lc.setChar(0,0,'a',false);

    delay(delaytime);
    Serial.println("setRow 0x05");
    lc.setRow(0,0,0x05);

    delay(delaytime);
    Serial.println("setChar d");
    lc.setChar(0,0,'d',false);

    delay(delaytime);
    Serial.println("setRow 0x1c");
    lc.setRow(0,0,0x1c);

    delay(delaytime);
    Serial.println("setRow 0x10");
